<aside id="left-panel" class="left-panel">
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="./"><img src="../templates/images/logo.png" alt="Logo"></a>
            <a class="navbar-brand hidden" href="./"><img src="../templates/images/logo2.png" alt="Logo"></a>
        </div>
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <h3 class="menu-title">Listas</h3><!-- /.menu-title -->
                <li class="" id="cat">
                ...
                <li class="" id="coment">
                    ...
                    <a href="admin/comentarios"> <i class="menu-icon fa fa fa-table"></i>Comentarios </a>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-sign-in"></i><a href="admin/login">Login</a></li>
                        <!-- <li><i class="menu-icon fa fa-sign-in"></i><a href="/register.html">Register</a></li> -->
                        <li><i class="menu-icon fa fa-paper-plane"></i><a href="admin/forget">Forget Pass</a></li>
                    </ul>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
