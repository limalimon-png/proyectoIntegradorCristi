...
<body>
    ...
    <div class="container ">
      ...
      <div class="row">
        ...
        <div class="col-12  col-sm-3 order-last mt-3 mt-sm-0 " style="text-align: end;">
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" onclick="cambiarPlaceHolder('Descripcion categoria')">Descripción categoría</a></li>
        ...
        <div class="col-12 col-sm-9">
          <form class="d-flex" role="search" id="formularioCategorias" onsubmit="buscarCategoria(event)">

            <input class="form-control me-2" type="search" placeholder="Nombre categoria" aria-label="Search" id="buscadorListadoCategorias">
  ...
  <div class="accordion container" role="tablist" id="accordion-2">
...
<footer style="height: 100px;">
  ...
  <script src="../templates/assets/js/filtrosListadoCategoria.js"></script>
</body>
