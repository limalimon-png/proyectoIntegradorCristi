...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="../templates/assets/bootstrap/css/bootstrap.min.css"
    />
  ...
  <body>
    ...
    <div class="simple-slider" >
      <div class="swiper-container">
        ...
        <div class="swiper-wrapper" id="sliders">
    ...
    <section class="py-4 py-xl-5">
      <div class="container h-100">
        <div  id="banner" class="text-white bg-primary border rounded border-0 p-4 py-5">
          <div class="row h-100">
            <div
            ...
            >
              <div id="containerInfo">
                <h1 class="text-uppercase fw-bold text-white mb-3">
    ...
    <script src="../templates/assets/js/home.js"></script>
