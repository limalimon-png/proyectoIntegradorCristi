<link rel="stylesheet" href="../templates/assets/css/publico.css">
<nav class="navbar navbar-light navbar-expand-md py-3">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navcol-3">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item">
              <a id="productos" class="nav-link" href="productos">Productos</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
            <a id="logout" class="nav-link" style="color:brown"  href="logout">logout</a>
            </li>
          </ul>
    ...
    <script src="../templates/assets/js/publico.js"></script>