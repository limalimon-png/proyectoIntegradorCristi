                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="admin/comentarios/actualizar" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return validarFormulario()">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="date" id="fecha" name="fecha" placeholder="Text" class="form-control" tipo="fecha"><div  class="invalid-feedback" >Introduce una fecha con formato aaaa-mm-dd</div></div>
                                    </div>
                                    <div class="row form-group">
